...
var UserModel = /** @class */ (function () {
    ...
    // Get Data
    UserModel.prototype.getUserByPhoneNumber = function (PhoneNumber) {
    ...
    UserModel.prototype.getPassword = function (Email) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // Add Data
    UserModel.prototype.registerUser = function (user) {
        return connectDB_1.database.add(user, tables_1.TBL_USER);
    };
    UserModel.prototype.addOTP = function (otp, Email) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rows = _a.sent();
                        if (rows.length != 0) {
                            connectDB_1.database.del({ Email: Email }, tables_1.TBL_OTP);
                        }
                        return [2 /*return*/, connectDB_1.database.add(otp, tables_1.TBL_OTP)];
                }
            });
        });
    };
    // Edit Date
    UserModel.prototype.editUser = function (User, IDUser) {
        return connectDB_1.database.patch(User, IDUser, tables_1.TBL_USER);
    };
    return UserModel;
}());
