...
var DiscountModel = /** @class */ (function () {
    ...
    DiscountModel.prototype.getDiscountByIDProduct = function (IDProduct) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DiscountModel.prototype.addNewDiscount = function (Discount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, connectDB_1.database.add(Discount, tables_1.TBL_DISCOUNT)];
            });
        });
    };
    return DiscountModel;
}());
exports.discountModel = new DiscountModel();
