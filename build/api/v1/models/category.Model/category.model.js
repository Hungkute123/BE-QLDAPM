...
var CategoryModel = /** @class */ (function () {
    ...
    CategoryModel.prototype.getCategoryProductByLevel = function (Level) {
    ...
    CategoryModel.prototype.getCategoryProductByIDParentwithSetLimit = function (IDParent, limit) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoryModel.prototype.getCategoryProductByIDParent = function (IDParent) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
